...
let name = "Keisha"
let number = 350
let adjective = "custom-made"
let noun = "shock sticks"
let place = "palace"
let posemote = "excited"
let negemote = "disappointed"
let shockString = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(posemote). But then they felt \(negemote). They were all out of \(noun)."
