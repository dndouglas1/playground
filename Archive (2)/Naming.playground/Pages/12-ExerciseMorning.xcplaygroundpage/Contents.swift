...
let TotalTime = brushTeeth + gettingDressed + chooseClothes + shower + videogames + messaround
...
let need = brushTeeth + gettingDressed + chooseClothes + shower
let want = videogames + messaround
